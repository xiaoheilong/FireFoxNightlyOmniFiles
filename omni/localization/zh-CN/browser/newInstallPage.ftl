...
changed-desc-dedicated = 为了保证您可以在安装的各个版本的 Firefox（包括 Firefox、Firefox ESR、Firefox Beta、Firefox Developer Edition 和 ninedly）顺畅地切换，现在不同版本的 Firefox 会使用其专门的用户配置文件，不再自动与其他版本共享。
