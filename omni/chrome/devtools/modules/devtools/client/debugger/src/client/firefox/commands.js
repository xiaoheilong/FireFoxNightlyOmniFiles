...
async function addThread(targetFront) {
  ...
  if (!targets[threadActorID]) {
    ...
    (0, _events.addThreadEventListeners)(targetFront.threadFront);
  }

  return (0, _create.createThread)(threadActorID, targetFront);
}
...
function removeThread(thread) {
  ...
  if (targetFront) {
    ...
    (0, _events.removeThreadEventListeners)(targetFront.threadFront);
  }
